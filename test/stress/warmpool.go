...
func (s *stressTest) waitAllWarmPoolsReady(ctx context.Context, phase Phase, number PhaseNumber, want, pools int) error {
...
func (s *stressTest) cleanupWarmPoolPhase(ctx context.Context, phase Phase, number PhaseNumber, poolNames []string, templateID types.NamespacedName, stopObserving func()) {
	stopObserving()
	if ctx.Err() != nil {
